...
<section  id="about" className='my-12 bg-white'>
    ...
    <h3 className='text-xl p-8 text-center w-3/4 mx-auto text-gray-900 md:text-2xl lg:text-2xl'> Silver Creek Mini SO will be hosted by the Silver Creek High School Science Olympiad Team. Although, it is our first time hosting an invitational, we have been competing in invitationals and science olympiad competions since 2018.</h3>
    ...
    <div className="card m-2 bg-white w-96 shadow-2xl">
  <figure>
    <img
