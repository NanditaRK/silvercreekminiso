  ...
  const accordionData = [
    {
      ...
      answer: (
        <>
          <p className="mb-2 text-gray-500 dark:text-gray-400">Contact the specific Event Supervisor that can be found in the <Link className='text-green-700 underline' to='#OurTeam'>Our Team</Link> section.</p>
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          <p className="mb-2 text-gray-500 dark:text-gray-400">
            The cost to register for one team is $65.
          </p>
    ...
    },
    {
      ...
      answer: (
        <>
          <p className="mb-2 text-gray-500 dark:text-gray-400">
            The event will be held on January 11, 2025 as an online invitational that can be done from home.
          </p>
